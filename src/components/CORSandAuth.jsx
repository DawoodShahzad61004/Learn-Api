  ...
  return (
    <div className="text-gray-700 space-y-6">
      <div>
        ...
        <p>
          ...
          it affects frontend-backend communication. Learn how to handle CORS errors
          and configure your server correctly.
        </p>
    ...
    <div className="bg-white p-6 border rounded-lg shadow-sm space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Try making an authenticated request to a protected backend endpoint using a JWT token.
        This simulates how CORS and Auth headers are handled.
      </p>
      ...
      {response && (
        <div className="bg-gray-100 mt-4 p-4 rounded-lg">
          ...
          <pre className="text-sm text-gray-800 overflow-x-auto">{response}</pre>
        </div>
      )}
...
{`fetch("http://localhost:5000/protected", {
  ...
  credentials: "include"
            ...
            <p>Use <code>Authorization: Bearer &lt;token&gt;</code> and <code>credentials: "include"</code> to simulate protected CORS calls.</p>
          </div>
...
app.listen(5000);`}
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              <li>Browser sends preflight OPTIONS request (for non-simple requests)</li>
